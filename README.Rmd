...
You can install the development version of `centerline` from [GitHub](https://github.com/) with `pak`:
...
<details>
<summary>cnt_skeleton() code 👇</summary>
```{r skeletons_plot}
library(ggplot2)
...
<details>
<summary>cnt_path_guess() code 👇</summary>
```{r centerline_plot}
